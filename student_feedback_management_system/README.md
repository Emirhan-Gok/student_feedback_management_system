...
- Email notifications
- Automated testing
- Modernise the UI by integrating Bootstrap throughout the project, including the student and teacher dashboards. This is to create a more consistent and readable interface while reducing unnecessary custom CSS.
